  ...
  extends ItemFood
{
  ...
  public ItemJoint(int p_i45341_1, float p_i45341_2, boolean p_i45341_3_)
  {
  ...
  protected void onFoodEaten(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
  {
    ...
    if (par1ItemStack.getItemDamage() == 0)
    {
      if (!par2World.isClient)
      {
        par3EntityPlayer.addPotionEffect(new PotionEffect(Potion.regeneration.id, 100, 4));
        par3EntityPlayer.addPotionEffect(new PotionEffect(Potion.confusion.id, 300, 10));
        par3EntityPlayer.addPotionEffect(new PotionEffect(Potion.moveSpeed.id, 180, 5));
      }
    }
    else {
  ...
  {
    p_150895_3_.add(new ItemStack(p_150895_1, 1, 0));
  }
}
